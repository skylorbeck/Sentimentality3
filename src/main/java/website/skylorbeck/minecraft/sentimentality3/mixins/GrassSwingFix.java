...
public class GrassSwingFix {
    ...
    private boolean checkForEntity(ClientPlayerInteractionManager manager, BlockPos pos, Direction direction) {
        ...
        EntityHitResult result = ProjectileUtil.getEntityCollision(world, player, camera, end, new Box(camera, end), EntityPredicates.EXCEPT_CREATIVE_OR_SPECTATOR.and(e -> e.collidesWith(player) && e instanceof LivingEntity));
